...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_3.setText(QCoreApplication.translate("Form", u"Time", None))
        self.pushButton_4.setText(QCoreApplication.translate("Form", u"Speed", None))
    # retranslateUi
